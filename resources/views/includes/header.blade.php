<header class="absolute inset-x-0 top-0 z-50 h-28 bg-gray-500 bg-opacity-25">
    <nav class="flex items-center justify-between p-6 lg:px-8" aria-label="Global">
        ...
        <div class="hidden lg:flex lg:flex-1 lg:justify-end">
            <a href="/customer-login" class="inline-flex items-center rounded-md bg-yellow-600 px-6 py-3 text-lg font-semibold text-white shadow-md hover:bg-indigo-600">Get Started &rarr;</a>
        </div>
    </nav>
  </header>