...
<body class="bg-gray-100">
    ...
    <section class="hero-section relative flex items-center justify-center h-screen bg-cover bg-center">
        ...
        <div class="relative z-10 text-center text-white px-6 md:px-12">
            ...
            <a href="/customer-login" class="mt-6 inline-block bg-yellow-600 px-6 py-3 text-lg font-semibold text-white rounded-md shadow-md hover:bg-indigo-600">Get Started</a>
        </div>
    </section>
